                    ...
                    <dhcp>
                        <excluded-address xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-dhcp">
                            <low-high-address-list>
                                <low-address>192.168.10.1</low-address>
                                <high-address>192.168.10.10</high-address>
                            </low-high-address-list>
                        </excluded-address>
                        <pool xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-dhcp">
                            <id>1</id>
                            <default-router>
                                <default-router-list>192.168.10.1</default-router-list>
                            </default-router>
                            <network>
                                <primary-network>
                                <number>192.168.10.1</number>
                        ...
                        <excluded-address xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-dhcp">
                            <low-high-address-list>
                                <low-address>192.168.20.1</low-address>
                                <high-address>192.168.20.10</high-address>
                            </low-high-address-list>
                        </excluded-address>
                        <pool xmlns="http://cisco.com/ns/yang/Cisco-IOS-XE-dhcp">
                            <id>2</id>
                            <default-router>
                                <default-router-list>192.168.20.1</default-router-list>
                            </default-router>
                            <network>
                                <primary-network>
                                <number>192.168.20.1</number>
                                <mask>255.255.255.0</mask>
                                </primary-network>
                            </network>
                        </pool>
